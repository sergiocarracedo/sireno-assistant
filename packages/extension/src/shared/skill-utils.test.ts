...
describe("skill-utils", () => {
  ...
  describe("skillMatchesDomain", () => {
    ...
    it("should match URL pattern", () => {
      ...
      expect(skillMatchesDomain(skill, "linkedin.com", "https://linkedin.com/jobs/search")).toBe(
        true,
      );
    ...
    it("should match regex pattern against URL", () => {
      ...
      expect(skillMatchesDomain(skill, "example.com", "https://example.com/form/contact")).toBe(
        true,
      );
