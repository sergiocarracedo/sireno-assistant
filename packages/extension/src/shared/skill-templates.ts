...
export const DEFAULT_SKILLS: Skill[] = [
  {
    ...
    description:
      "Automatically fills personal information fields with your customized data across all websites",
...
IMPORTANT: User must edit this skill and add their actual information before using it.`,
  ...
  },
  {
    ...
    description:
      "Generates professional, formal business language optimized for LinkedIn profiles and communications",
...
- Maintain third-person perspective for bio sections`,
  ...
  },
  {
    ...
    description:
      "Creates friendly, conversational content for Twitter, Facebook, Instagram, and other social platforms",
...
- Make it shareable and relatable`,
  ...
  },
  {
    ...
    description:
      "Fixes grammar, spelling, and punctuation errors while preserving original meaning and tone",
...
- Only make corrections, not improvements`,
  ...
  },
  {
    ...
    description:
      "Intelligently formats addresses, phone numbers, dates, names, and emails to standard conventions",
