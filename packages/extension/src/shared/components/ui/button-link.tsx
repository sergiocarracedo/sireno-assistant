...
export interface ButtonLinkProps
  extends React.AnchorHTMLAttributes<HTMLAnchorElement>, VariantProps<typeof buttonLinkVariants> {
  icon?: LucideIcon;
...
const ButtonLink = React.forwardRef<HTMLAnchorElement, ButtonLinkProps>(
  ({ className, variant, size, icon: Icon, iconPosition = "left", children, ...props }, ref) => {
    ...
    return (
      <a className={cn(buttonLinkVariants({ variant, size, className }))} ref={ref} {...props}>
