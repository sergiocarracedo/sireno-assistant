            ...
            <div>
              ...
              <ul className="space-y-1 text-gray-600 dark:text-gray-400 ml-4">
                <li className="flex gap-2">
                  <span>•</span>
                  <span>
                    <strong>Name:</strong> Short, descriptive name (e.g., &quot;LinkedIn
                    Helper&quot;)
                  </span>
                </li>
                <li className="flex gap-2">
                  <span>•</span>
                  <span>
                    <strong>Description:</strong> What this skill does
                  </span>
                </li>
                <li className="flex gap-2">
                  <span>•</span>
                  <span>
                    <strong>Domain Match:</strong> Where it activates (see Domain Matching below)
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              ...
              <CodeExample code="linkedin.com" title="Activates only on linkedin.com" />
            </div>
            ...
            <div>
              ...
              <CodeExample code="*" title="Activates on all websites" />
            </div>
          </div>
        ...
        <section>
          ...
          <div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900 mt-4">
            <div className="text-xs text-blue-800 dark:text-blue-300">
              <strong>Cost Tip:</strong> Start with &quot;Selected Fields Only&quot; and upgrade to
              broader context only when needed. This saves API costs while maintaining quality.
            </div>
          </div>
        </section>
      )}
