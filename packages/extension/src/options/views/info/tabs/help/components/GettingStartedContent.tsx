        ...
        <section>
          ...
          <ol className="space-y-3 text-gray-600 dark:text-gray-400">
            ...
            <li className="flex gap-2">
              ...
              <span>Click on any text input or textarea field</span>
            </li>
            <li className="flex gap-2">
              <span className="font-semibold text-gray-900 dark:text-gray-100 min-w-[1.5rem]">
                3.
              </span>
              <span>Look for the purple AI assistant icon that appears near the field</span>
            </li>
            <li className="flex gap-2">
              <span className="font-semibold text-gray-900 dark:text-gray-100 min-w-[1.5rem]">
                4.
              ...
              <span>
                ...
                <kbd className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-800 rounded text-xs">
                  Ctrl+Space
                </kbd>
              </span>
            </li>
            <li className="flex gap-2">
              ...
              <span>
                Type your request (e.g., &quot;Write a professional introduction&quot;) and press
                Enter
              </span>
            </li>
          </ol>
