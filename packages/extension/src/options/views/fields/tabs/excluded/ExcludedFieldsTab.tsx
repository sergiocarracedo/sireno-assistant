...
export default function ExcludedFieldsTab() {
  ...
  const loadExcludedFields = async () => {
    ...
    try {
      ...
      const excludedKeys = Object.keys(allStorage).filter((key) =>
        key.startsWith("excluded_fields_"),
      );
      ...
      <div className="p-4 border-b space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <Button variant="outline" size="sm" onClick={loadExcludedFields}>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center text-gray-500">
                ...
                <p className="text-sm">
                  Click the &quot;Exclude field&quot; button in the inline chat to hide the
                  assistant button for specific fields.
                </p>
              </div>
            </CardContent>
          </Card>
