    ...
    <div className="space-y-6 text-sm">
      ...
      {shouldShow('inline chat field ai assistant') && (
        <section>
          ...
          <div className="space-y-2">
            ...
            <CodeExample
              code="Write a professional bio in 150 words"
      ...
      {shouldShow('skills custom domain matching automatic') && (
        <section>
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
            Skills are pre-configured AI assistants that activate automatically on specific websites. 
            They provide domain-specific knowledge and shortcuts.
          </p>
        ...
        <section>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400 ml-4">
            ...
            <li className="flex gap-2">
              <span>•</span>
              <span>
                <strong className="text-gray-900 dark:text-gray-100">Focus</strong> on specific fields 
                - the page scrolls and highlights the field
              </span>
            </li>
            <li className="flex gap-2">
              <span>•</span>
              <span>
                <strong className="text-gray-900 dark:text-gray-100">Exclude</strong> fields from AI detection 
                (e.g., passwords, sensitive data)
              </span>
            </li>
          </ul>
