    ...
    <div className="flex flex-col h-full">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define the skill name and where it should be active
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Detailed instructions for the AI on how to behave
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure safety constraints for this skill
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
