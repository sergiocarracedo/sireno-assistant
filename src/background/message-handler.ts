...
import { getConfig, setConfig, getSkills, saveSkill, deleteSkill, getChatMessages, saveChatMessages, clearChatMessages, getLLMLogs, clearLLMLogs, addLLMLog, getExcludedFields, addExcludedField, removeExcludedField } from './storage';
...
IMPORTANT: Provide ONLY the new/transformed text value for the field. Do not include any explanations, quotes, or markdown. Just output the raw result text.`;
      ...
      case 'OPEN_SIDEBAR_CHAT': {
        ...
        try {
          ...
          logger.debug('Stored sidebar init data:', { fieldId: message.fieldId, inputText: message.inputText });
